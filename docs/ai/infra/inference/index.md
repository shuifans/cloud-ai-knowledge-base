...
![推理与算力已发布文章及计划扩充方向知识地图](/images/ai/infra/inference/inference-overview.png)
...
| [Token 经济学：定价与成本的数学](/ai/infra/inference/token-economics) | 已发布 | 2N/6N FLOPs 数学、成本结构与定价设计 |
